					...
					var e,
						n = (function () {
							var e,
								...
								T = { tr: f.createElement("tbody"), tbody: E, thead: E, tfoot: E, td: j, th: j, "*": f.createElement("div") },
							...
							function J(t) {
								try {
									return t
										? "true" == t || ("false" != t && ("null" == t ? null : +t + "" == t ? +t : /^[\[\{]/.test(t) ? r.parseJSON(t) : t))
										: t;
								} catch (e) {
									return t;
								}
									...
									return (
										...
										i.forEach(function (i) {
											!(function t(r, i, o) {
												for (n in i)
													o && (R(i[n]) || D(i[n]))
														? (R(i[n]) && !R(r[n]) && (r[n] = {}), D(i[n]) && !D(r[n]) && (r[n] = []), t(r[n], i[n], o))
														: i[n] !== e && (r[n] = i[n]);
											})(t, i, r);
										}),
										t
						...
						(function (e) {
								...
								return (
									(!r && t.isDefaultPrevented) ||
										...
										(r.defaultPrevented !== n
											...
											: "returnValue" in r
											? !1 === r.returnValue
											: r.getPreventDefault && r.getPreventDefault()) && (t.isDefaultPrevented = x)),
									t
								);
							}
							function w(t) {
							...
							(e.fn.delegate = function (t, e, n) {
												...
												c &&
													...
													r &&
														(f = function (t) {
															...
															if (a && a !== o)
																return (
																	(n = e.extend(w(t), { currentTarget: a, liveFired: o })),
								...
								(e.fn.trigger = function (t, n) {
									return (
										((t = a(t) || e.isPlainObject(t) ? e.Event(t) : T(t))._args = n),
										this.each(function () {
							...
							(h.href = t.location.href),
								...
								(e.ajax = function (i) {
									...
									if (
										...
										return T || (b.url = x(b.url, b.jsonp ? b.jsonp + "=?" : !1 === b.jsonp ? "" : "callback=?")), e.ajaxJSONP(b, E);
									var w,
										S = b.accepts[j],
										C = {},
										N = function (t, e) {
									...
									if (
										...
										N("Accept", S || "*/*"),
										(S = b.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]), P.overrideMimeType && P.overrideMimeType(S)),
										(b.contentType || (!1 !== b.contentType && b.data && "GET" != b.type.toUpperCase())) &&
											N("Content-Type", b.contentType || "application/x-www-form-urlencoded"),
										b.headers)
									)
											...
											if (4 == P.readyState) {
												...
												if ((P.status >= 200 && P.status < 300) || 304 == P.status || (0 == P.status && "file:" == O)) {
													if (
														((j =
															j ||
															((r = b.mimeType || P.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]),
														...
														try {
															(t = (function (t, e, n) {
																...
																"script" == j
																	...
																	: "xml" == j
																	? (t = P.responseXML)
																	: "json" == j && (t = f.test(t) ? null : e.parseJSON(t));
														} catch (i) {
															n = i;
														}
			...
			function (require, module, exports) {
				...
				delete Object.prototype.document,
					...
					t(function () {
						...
						function w() {
							u(), ++c > 150 && c % 8 == 0 && ((a.fillStyle = "rgba(0,0,0,.04)"), a.fillRect(-3 * n, -3 * n, 6 * n, 6 * n)), f(0.025);
						}
						function f(t) {
					...
					(window.onscroll = function () {
						t(window).scrollTop() > 0.6 * t(window).height() ? t(".background").addClass("fixed") : t(".background").removeClass("fixed");
					}),
					t(function () {
                        e(), console.log("%c 星宿君 %c", "background:#24272A; color:#e1d7ce", "", "https://www.huxinfeng.com/");
					});
			},
			{ zepto: "XR92" },
		],
